...
async function runTests() {
    server = app.listen(PORT, async () => {
        ...
        try {
            ...
            const dataValFail = await resValFail.json();
            ...
            const dataUser1Login = await resUser1Login.json();
            ...
            const dataUser2Login = await resUser2Login.json();
            ...
            const dataCreatePost = await resCreatePost.json();
            ...
            const dataCommentDraft = await resCommentDraft.json();
            ...
            const dataPubPost = await resPubPost.json();
            ...
            const dataCommentPub = await resCommentPub.json();
            ...
            const dataUserPosts = await resUserPosts.json();
